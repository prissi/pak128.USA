...
PAKID ?= pak128.USA version 0.1

DESTDIR  ?= simutrans
PAKDIR   ?= $(DESTDIR)/pak128.USA
ADDONDIR ?= $(DESTDIR)/addons/pak128.USA
DESTFILE ?= simupak128.USA
...
DIRS128 += city/res
DIRS128 += city/ind
DIRS128 += city/cityhall
DIRS128 += city/cur
DIRS128 += city/cur_land
DIRS128 += factories
